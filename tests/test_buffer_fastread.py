...
@pytest.mark.parametrize(
    ...
    [
        ("write", "00", "0x00000001", ["1_W_0_0x00000001"], "[Write] Done"),
        ("erase", "00", "01", ["2_E_0_1"], "[Erase] Done"),
        ("read", "00", "",           ["2_E_0_1"], "[Read] LBA 00 : 0x00000000"),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("write", "00", "0x00000001", ["2_W_0_0x00000001"], "[Write] Done"),
        ("read", "00", "",           ["2_W_0_0x00000001"], "[Read] LBA 00 : 0x00000001"),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("write", "00", "0x00000001", ["2_W_0_0x00000001"], "[Write] Done"),
        ("flush", "", "", ["2_empty"], "[Flush] Done"),
        ("read", "00", "",           ["2_empty"], "[Read] LBA 00 : 0x00000001"),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ("write", "00", "0x00000001", ["1_W_0_0x00000001"], "[Write] Done"),
        ("write", "00", "0x00000002", ["2_W_0_0x00000002"], "[Write] Done"),
        ("read", "00", "",           ["2_empty"], "[Read] LBA 00 : 0x00000002"),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ("write", "00", "0x00000001", ["1_W_0_0x00000001"], "[Write] Done"),
        ("write", "00", "0x00000002", ["2_W_0_0x00000002"], "[Write] Done"),
        ("write", "00", "0x00000003", ["3_W_0_0x00000003"], "[Write] Done"),
        ("write", "00", "0x00000004", ["4_W_0_0x00000004"], "[Write] Done"),
        ("write", "00", "0x00000005", ["5_W_0_0x00000005"], "[Write] Done"),
        ("read", "00", "",           ["2_empty"], "[Read] LBA 00 : 0x00000005"),
    ]
)
